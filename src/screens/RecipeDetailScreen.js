...
console.log('props.route.params:', props.route.params); // Log the entire params object
    ...
    const handleToggleFavorite = () => {
        ...
        if (setFavorites) {
            const updatedFavorites = isFavourite
                ? favorites.filter((fav) => fav.id !== item.idMeal)
                : [...favorites, item];
  ...
  return (
    <View className="flex-1 bg-white relative">
        ...
        <Animated.View entering={FadeIn.delay(200).duration(1000)} className="w-full absolute flex-row justify-between items-center pt-14">
            ...
            <TouchableOpacity onPress={navigateToFavorites} className="p-2 rounded-full mr-5 bg-white">
            <Text>Favorites</Text>
            </TouchableOpacity>
        </Animated.View>
